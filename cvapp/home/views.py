...
def gen_resume(request):
    ...
    if request.method == 'POST':
        ...
        school1 = request.POST.get('college1', '')

        year1 = request.POST.get('year1', '')

        degree2 = request.POST.get('degree2', '')

        school2 = request.POST.get('college2', '')
        ...
        return render(request, 'resume.html', {'name': name,
                                            ...
                                            'skill3': skill3,
                                               ...
                                               'skill3': skill3, 'degree1': degree1,

                                               'college1': school1, 'year1': year1,
                                               ...
                                               'degree2': degree2, 'college2': school2,
